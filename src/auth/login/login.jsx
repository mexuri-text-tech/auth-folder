...
function Login() {
    const googleAuth = () => {
        window.open(
            `${import.meta.env.VITE_REACT_APP_API_URL}/auth/google`,
            "_self"
        );
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                // Call fetchAndSaveUser to set localStorage and redirect
                    ...
                    <form noValidate onSubmit={handleSubmit}>
                        <div className="email" id={errorMessage ? 'input-error' : ''}>
                            ...
                            <div className="email-input">
                                <input type="email" name="email" spellCheck="false" autoCorrect="off" id="email" placeholder="Email" autoComplete="e-mail" required  value={email} onChange={(e) => setEmail(e.target.value)} />
                            </div>
                        </div>
